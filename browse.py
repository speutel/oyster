...
if 'mode' in form and form['mode'].value == 'editplaylist':
    ...
    print "<ul>"
    print "<li><a href='browse.py?mode=editplaylist&amp;playlist=" + urllib.quote(form['playlist'].value) +\
          "'>Browse</a></li>"
    print "<li><a href='search.py?mode=playlist&amp;playlist=" + urllib.quote(form['playlist'].value) +\
          "'>Search</a></li>"
    print "</ul>"
    print "</div></div>"
